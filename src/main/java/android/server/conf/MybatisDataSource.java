...
//mybaits dao 搜索路径
@MapperScan("android.server.dao")
public class MybatisDataSource {
	@Autowired
	private DataSourceProperties dataSourceProperties;
	//mybaits mapper xml搜索路径
	private final static String mapperLocations="classpath:android/server/dao/*.xml"; 
	...
	public SqlSessionFactory sqlSessionFactoryBean() throws Exception {		
		...
		sqlSessionFactoryBean.setTypeAliasesPackage("android.server.model");
